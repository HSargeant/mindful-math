                ...
                <div className="block w-full overflow-x-auto">
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody>
                            ...
                            <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 whitespace-nowrap p-4">{new Date(item.dueDate).toDateString()}</td>
                            <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 whitespace-nowrap p-4">
                                <div className="flex flex-col">
                                    ...
                                    <button type="submit" className="white"><i className="fas fa-trash"></i></button>
                                    </form>
                                </div>
                            </td>
                            </tr>
